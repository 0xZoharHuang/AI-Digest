...
phase2_evidence_packets = {str(runtime.codex.phase2_evidence_packets).lower()}
phase2_reading_view = {str(runtime.codex.phase2_reading_view).lower()}
phase3_lean_instructions = {str(runtime.codex.phase3_lean_instructions).lower()}
phase2_alias_model = {q(runtime.codex.phase2_alias_model)}
phase2_alias_reasoning = {q(runtime.codex.phase2_alias_reasoning)}
